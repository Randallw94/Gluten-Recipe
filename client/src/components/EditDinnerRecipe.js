...
// test
    ...
    const handleSubmit= (e)=>{
      ...
      axios.put(`http://localhost:8000/api/v1/dinner/recipes/${id}`, breakfastRecipe)
      .then((recipe)=>{
          console.log(recipe)
          navigate("/dinner")
      })
  ...
  return (
    <div style={{backgroundColor:"#d5e1e1"}}>
...
export default EditDinnerRecipe